...
class_name VisualShaderNodeSawtoothWave
...
func _get_code(input_vars, output_vars, mode, type):
	...
	return "%s = sawtooth_wave(%s, %s, %s, %s);" % [output_vars[0], input_vars[0], input_vars[1], input_vars[2], input_vars[3]]
